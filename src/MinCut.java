...
/**
 * Created by Francis Cáceres on 7/6/2016.
 */
public class MinCut {
    ...
    private static class Edge {
        ...
        public Edge( Vertex fst, Vertex snd ) {
            if( fst == null || snd == null ) {
                throw new IllegalArgumentException( "Se necesitan ambos vertices" );
            }
            ends.add( fst );
            ends.add( snd );
        }
    ...
    public static void main( String[] args ) {
        int[][] arr = getArray( "C:\\Users\\Francis Cáceres\\Documents\\kargerMinCut.txt" );
